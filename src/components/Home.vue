...
<div class="home" id="Home">
  ...
  <v-app>
      ...
      />  
      <v-icon style="top: 14%;" nav min-width color="blue" light v-text="'fa-envelope-o'" class=icons  @click="showContact()" ></v-icon> 
  ...
  <router-view/>
      <b-modal  class="contactUS"  ref="my-modal" size="md" centered hide-footer title="Contact Us !">
      <div class="d-block text-center">
        <p>Want to discuss some work?<br/> Just drop a message below or mail us at <a href="info@decabits.com">info@decabits.com</a></p>
      </div>
    ...
    <p class="validate">{{errors.message}}</p>
         ...
         <b-button type="submit" style="margin:auto;display:flex" variant="primary">Submit</b-button>
        </form>
    
    
      
     
      <div style="margin-top:20px;  width:100%; justify-content:center; display:flex">
        
      <a href="https://www.linkedin.com/company/decabits/" target="_blank"><i class="fab fa-linkedin fa-2x" style="margin:5px 5px; color: #0077B7"></i></a> 
      <a href="https://github.com/decabits" target="_blank"><i class="fab fa-github fa-2x" style="margin:5px 5px; color:black;"></i></a>
      </div>
    </b-modal>
    <v-snackbar
      v-model="snackbar"
  ...
  methods:{
    ...
    submitData(e){
      ...
      if(this.form.name == ""){
        ...
        this.errors.name = ""
         document.getElementById("your_name").style.borderColor = "green"
      }
      ...
      if(this.errors.name == ""  && this.errors.email == "" && this.errors.phone == ""  && this.errors.message == ""){
        ...
        this.axios.post('http://blog.entnetwrk.com/contact.php', newData)
        .then(res=>{
          this.snackbar=true
